<template>
  <div>
    <b-button id="show-btn" class="mt-3" @click="showModal">Rent</b-button>

    <b-modal ref="my-modal" hide-footer title="Rent the Fire Extinguisher">
      <div class="calendar-container">
        <div class="text-container pr-2">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero quae
            cumque beatae reiciendis mollitia provident?
          </p>
        </div>
